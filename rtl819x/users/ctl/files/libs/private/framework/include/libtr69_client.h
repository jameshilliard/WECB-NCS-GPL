 ...
 *
 *	[DESCRIPTION]:
 *	        get next child node parameter's attribute, usually used in traveling 
...
/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tr69_get_next_inst_node
 *
 *	[DESCRIPTION]:
 *	        get next Instance parameter's attribute, usually used in traveling 
 *              whole node tree loops.(compare to tr69_get_next_node(), this 
 *              function only return with OBJECT Node)
 *              for samples, please see tr69.c:GetParameterValue()  
 *
 ...
 *              <  0          ERROR
 **************************************************************************/
int tr69_get_next_inst_node(char *p_root_name, tr69_node_t **pp_next_node);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tr69_get_next_samedepth_node
 *
 *	[DESCRIPTION]:
 *	        get next same depth parameter's attribute, usually used in traveling 
 *              whole node tree loops.(compare to tr69_get_next_node(), this 
 *              function could return with OBJECT/INSTANCE/LEAF Node)
 *              for samples, please see tr69.c:GetParameterValue()  
 *
 *	[ARGUMENT]:
 *	        char *p_root_name
 ...
 *              <  0          ERROR
 **************************************************************************/
int tr69_get_next_samedepth_node(char *p_root_name, tr69_node_t **pp_next_node);
...
/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_commit_set_leaf_data
 *
 *	[DESCRIPTION]:
 *	        OBJECT SET. set leaf parameter. the value will not take affect 
 *              with the data_center immediately but saved into buffer, 
 *              The OBJECT SET Function will be called until a user calling 
 *              tr69_commit_set_leaf_data_end finally. Then SET Function can get
 *              completely different Object Current_Data, Object New_Data. 
 *
 *	[ARGUMENT]:
 *	        char *p_name
 *	        void *p_value
 ...
 *              <  0          ERROR
 **************************************************************************/
int tr69_commit_set_leaf_data(char *p_name, void *p_value, int type);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_commit_set_leaf_data_end
 *
 *	[DESCRIPTION]:
 *	        OBJECT SET. Commit set leaf parameter value end, calling this function 
 *              will call the OBJECT SET function. Then OBJECT SET Function can get
 *              completely different Object Current_Data, Object New_Data. 
 *
 *	[ARGUMENT]:
 *	        char *p_name
 ...
 *              <  0          ERROR
 **************************************************************************/
int tr69_commit_set_leaf_data_end(char *p_name);
 ...
 *              <  0          ERROR
 **************************************************************************/
int tr69_move_instance(char *p_name_dstobj, char *p_name_srcinst, int *p_inst_numb);
