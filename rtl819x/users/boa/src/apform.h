...
extern void actWlgetPinStatus(request *wp, char *path, char *query);
...
extern void actAdvLocalSsh(request *wp, char *path, char *query);
extern void actgetSshParams(char *parambuf);
extern void actgetCurrentAddrInfo(request *wp, char *path, char *query);
extern void actPassword(request *wp, char *path, char *query);
extern void actForgotPassword(request *wp, char *path, char *query);
extern void actGotSerialNum(request *wp, char *path, char *query);
